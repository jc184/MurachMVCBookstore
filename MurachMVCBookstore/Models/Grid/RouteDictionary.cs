...
namespace MurachMVCBookstore.Models.Grid
{
    ...
    public class RouteDictionary : Dictionary<string, string>
    {
        ...
        public void ClearFilters()
        {
            GenreFilter = FilterPrefix.Genre + BooksGridDTO.DefaultFilter;
            PriceFilter = FilterPrefix.Price + BooksGridDTO.DefaultFilter;
            AuthorFilter = FilterPrefix.Author + BooksGridDTO.DefaultFilter;
        }
